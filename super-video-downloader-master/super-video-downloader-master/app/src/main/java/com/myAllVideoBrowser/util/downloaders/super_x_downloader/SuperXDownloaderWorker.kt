...
class SuperXDownloaderWorker(appContext: Context, workerParams: WorkerParameters) :
    ...
    override fun finishWork(item: VideoTaskItem?) {
        ...
        val notificationData = notificationsHelper.createNotificationBuilder(item.also {
            ...
            it.lineInfo = applicationContext.getString(R.string.download_status_success)
            }
        })
        ...
        when (item.taskState) {
            ...
            VideoTaskState.SUCCESS -> {
                ...
                saveProgress(
                    ...
                    applicationContext.getString(R.string.video_move_downloads)
                )
                ...
                saveProgress(
                    ...
                    applicationContext.getString(
                        if (fileMoved) R.string.download_status_success
                        else R.string.download_status_failed
                    )
                )
                if (fileMoved) {
                    ...
                    saveProgress(
                        ...
                        successProgress,
                        VideoTaskState.SUCCESS,
                        applicationContext.getString(R.string.download_status_success)
                    )
                } else {
                    ...
                    saveProgress(
                        ...
                        finalProgress,
                        item.taskState,
                        applicationContext.getString(R.string.media_move_error)
                    )
                }
            }
