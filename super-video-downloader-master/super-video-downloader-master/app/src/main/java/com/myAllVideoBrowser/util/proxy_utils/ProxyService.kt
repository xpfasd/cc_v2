...
class ProxyService : Service() {
    ...
    override fun onCreate() {
        ...
        if (!ProxyFeatureGate.isLocalProxyAvailable()) {
            AppLogger.i("ProxyService created while proxy support is disabled. Stopping immediately.")
            stopSelf()
            return
        }
        isRunning = true
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        if (!ProxyFeatureGate.isLocalProxyAvailable()) {
            AppLogger.i("ProxyService start ignored because proxy support is disabled.")
            stopSelf()
...
//        }
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText(getString(R.string.proxy_service_notification_message))
            .build()
    }
}
