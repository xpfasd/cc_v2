...
class SettingsViewModel @Inject constructor(
    ...
    val openPasswordFlowEvent = SingleLiveEvent<Void?>()
    val downloadLocationClickEvent = SingleLiveEvent<Void?>()
    val languageClickEvent = SingleLiveEvent<Void?>()
    val scoreClickEvent = SingleLiveEvent<Void?>()
    val shareClickEvent = SingleLiveEvent<Void?>()
    val privacyPolicyClickEvent = SingleLiveEvent<Void?>()
    ...
    fun openPasswordFlow() {
        openPasswordFlowEvent.call()
    }
    ...
    fun onDownloadLocationClick() {
        downloadLocationClickEvent.call()
    }

    fun onLanguageClick() {
        languageClickEvent.call()
    }

    fun onScoreClick() {
        scoreClickEvent.call()
    }
